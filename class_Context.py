...
class FQHost(object):
  ...
  def get_fqhost_view(self):
    ...
    self.query =  """select row_to_json(x) from (select ndr.vlan_name, vi.vlan, vi.interface, vi.ddns_suffix, ndr.network_name, n.network_address, n.gateway_address
    ...
    role_to_json = fd.to_json(self.role_code, services )
