...
class Domain(object):
  ...
  def get_domain_data(self, domain_name):
    ...
    self.domain_all = self.postgres.pool_query(self.query)
    print('get_domain_data', type(self.domain_all), self.domain_all)
    return (self.domain_all[0], self.domain_all[1])
