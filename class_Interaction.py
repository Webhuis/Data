...
logger.add('/var/log/Data_log/ZMQ_event.log', filter = lambda record: 'ZMQ' in record['extra'])
...
logger.add('/var/log/Data_log/ZMQ_error.log', filter = lambda record: 'ZMQ' in record['extra'] )
